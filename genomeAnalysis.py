...
sars_cov2 = pairwise2.align.globalxx(sars.seq, cov2.seq, one_alignment_only=True, score_only=True)
print('SARS/COV2 Similarity (%):', sars_cov2 / len(sars.seq) * 100)
...
print('MERS/COV2 Similarity (%):', cov2_mers / len(mers.seq) * 100)
...
plt.xlabel('Strands')
plt.ylabel('Weights')
X = ['SARS/COV2','SARS/MERS','MERS/COV2']
Y = [sars_cov2/ len(sars.seq) * 100, cov2_mers/ len(mers.seq)*100, sars_mers/len(sars.seq)*100]
